...
public class InitialConditionsMacro {
     ...
     */
    public InitialConditionsMacro(List<MacroCondition> macroIC) {
        ...
        for (int i = 0; i < size; i++) {
            MacroCondition localMacroIC = macroIC.get(i);
    ...
    private static boolean useUserDefinedSpeeds(List<MacroCondition> macroIC) {
