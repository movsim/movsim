...
/**
 * The Class LongitudinalModelInputDataACC.
 */
public class LongitudinalModelInputDataACC extends LongitudinalModelInputData {

    /** The Constant logger. */
    final static Logger logger = LoggerFactory.getLogger(LongitudinalModelInputDataACC.class);
    ...
    /**
     * Instantiates a new model input data ACC.
     * 
     * @param map
     *            the map
     */
    public LongitudinalModelInputDataACC(Map<String, String> map) {
        super(ModelName.ACC);
