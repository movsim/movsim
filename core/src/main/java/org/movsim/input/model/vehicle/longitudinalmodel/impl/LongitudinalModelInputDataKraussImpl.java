...
/**
 * The Class LongitudinalModelInputDataKraussImpl.
 * 
 * @author ralph
 */
public class LongitudinalModelInputDataKraussImpl extends LongitudinalModelInputDataImpl implements
        LongitudinalModelInputDataKrauss {

    /** The Constant logger. */
    final static Logger logger = LoggerFactory.getLogger(LongitudinalModelInputDataKraussImpl.class);
     ...
     *            the map
     */
    public LongitudinalModelInputDataKraussImpl(Map<String, String> map) {
