...
/**
 * The Class LongitudinalModelInputDataGippsImpl.
 */
public class LongitudinalModelInputDataGippsImpl extends LongitudinalModelInputDataImpl implements
        LongitudinalModelInputDataGipps {

    /** The Constant logger. */
    final static Logger logger = LoggerFactory.getLogger(LongitudinalModelInputDataGippsImpl.class);
     ...
     *            the map
     */
    public LongitudinalModelInputDataGippsImpl(Map<String, String> map) {
