...
// final List<Element> icMicroElems = elem.getChild(XmlElementNames.RoadInitialConditions) == null ? new
// ArrayList<Element>()
...
// final List<Element> icMacroElems = elem.getChild(XmlElementNames.RoadInitialConditions) == null ? new
// ArrayList<Element>()
// : elem.getChild(XmlElementNames.RoadInitialConditions).getChildren(
