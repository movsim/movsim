...
/**
 * The Class LongitudinalModelInputDataKrauss.
 * 
 */
public class LongitudinalModelInputDataKrauss extends LongitudinalModelInputData {

    /** The Constant logger. */
    final static Logger logger = LoggerFactory.getLogger(LongitudinalModelInputDataKrauss.class);
    ...
    /**
     * Instantiates a new acceleration model input data Krauss.
     * 
     * @param map
     *            the map
     */
    public LongitudinalModelInputDataKrauss(Map<String, String> map) {
