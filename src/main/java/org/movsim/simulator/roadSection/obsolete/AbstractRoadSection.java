...
//            this.vehGenerator = null;// new VehicleGenerator(projectMetaData, inputData, heterogenInputData,
//                                     // isWithFundamentalDiagramOutput);
//        } else {
...
//     *            the time
//     */
//    public void updateUpstreamBoundary(long iterationCount, double dt, double simulationtime) {
...
//                    if (vehFront != null) {
//                        logger.error("with veh in front at x = {} on lane = {}", vehFront.getPosition(),
//                                egoVeh.getLane());
//                    }
...
//                                veh.getPosition(), veh.getSpeed(), veh.accModel(), veh.getLength(), veh.getLane(),
//                                veh.getId()));
//                    }
