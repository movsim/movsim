...
/**
 * The Class LongitudinalModelInputDataKKWImpl.
 */
public class LongitudinalModelInputDataKKWImpl extends LongitudinalModelInputDataImpl implements
        LongitudinalModelInputDataKKW {

    /** The Constant logger. */
    final static Logger logger = LoggerFactory.getLogger(LongitudinalModelInputDataKKWImpl.class);
     ...
     *            the map
     */
    public LongitudinalModelInputDataKKWImpl(Map<String, String> map) {
        super(ModelName.KKW);
