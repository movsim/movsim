...
set title "C100 [liters/100 km] for template Diesel vehicle"
set zrange [0:20]
unset ztics 
...
set title "C100 [liters/100 km] for template Benzin vehicle"
...
set title "specific consumption(f,pressure) [g/kWh] for template Diesel vehicle"
set zrange [200:500]
unset ztics 
...
set title "specific consumption(f,pressure) [g/kWh] for template Benzin vehicle"
...
set title "specific consumption (f,power) [g/kWh] for template Diesel vehicle"
set xrange [800:4500]
set ylabel "Power [kW]"
set yrange [0:95]
...
set title "specific consumption (f,power) [g/kWh] for template Benzin vehicle"
